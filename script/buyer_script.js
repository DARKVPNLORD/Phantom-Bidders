    ...
    featureCards.forEach((card, index) => {
        ...
        button.addEventListener('click', function() {
            ...
            if (buttonText.includes('Browse')) {
                window.location.href = '../html/browse_auctions.html';
            } else if (buttonText.includes('Live')) {
                // window.location.href = '../html/live_auctions.html';
            } else if (buttonText.includes('Alerts')) {
                // window.location.href = '../html/alerts_settings.html';
            }
        });
    });
